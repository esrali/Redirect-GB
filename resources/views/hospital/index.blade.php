            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">All Hospital</h5>
                        </div>
                        <a href="{{url('hospitals/create')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Admin</a>
                    </div>
                </div>
                        ...
                        @endif    
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $hospital->location }}</p>
                                    </td>
                                    <td class="text-center">
